...
[Title("Custom", "Curl Noise")]
public class CurlNoiseNode : CodeFunctionNode
{
    public CurlNoiseNode()
    {
        name = "Curl Noise";
    }
    ...
    {
        return GetType().GetMethod("myCurlNoise", BindingFlags.Static | BindingFlags.NonPublic);
    }

    static string myCurlNoise(
